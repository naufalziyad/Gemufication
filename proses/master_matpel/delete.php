...
$id     = $_GET["id"];
				...
				$cek_query_ujian = mysql_query("select*from ujian where id_matpel='$id'");
			...
			$set = mysql_query("delete from matpel where id='$id'");
			if($set){
				$form1  = "<form method='POST' action='../../' id='alert'>";
				$form1 .= "<input type='hidden' name='success' value='delete'>";
				$form1 .= "<input type='hidden' name='page' value='Kategori'>";
				$form1 .= "</form>";
