...
<html lang="en">
  ...
  <body>
	<div class="jumbotron">
        <h1>Gamefication To Do List</h1>
        <p class="lead">Penerapkan Unsur Game Pada <?php echo $brand; ?></p>
    </div>
    ...
    <div class="container">
      ...
      <form class="form-signin" method="POST" action="signin_proses.php">
        ...
        <label class="checkbox">
          <input type="checkbox" value="remember-me"> Remember me,&nbsp;&nbsp;<a href="sign_up.php" >Sign up here</a>
        </label>
